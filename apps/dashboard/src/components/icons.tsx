...
export function SeverityDot({ color, className = "w-2 h-2" }: { color: string; className?: string }) {
  return (
...
export function SettingsIcon({ className = "w-5 h-5" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M10 1v2m0 14v2M3.93 3.93l1.41 1.41m9.32 9.32 1.41 1.41M1 10h2m14 0h2M3.93 16.07l1.41-1.41m9.32-9.32 1.41-1.41" />
    </svg>
  );
}
